...
public class Catapult extends Mechanism
{


    //feature/jacob contructor
    public Catapult(String property, boolean activated, int x, int y, int endX, int endY, Color myColor, int associatedMechanisms, LoadLevel ll)
    {
